-- password : 1234
INSERT INTO TBL_MEMBER VALUES (SEQ_MEMBER_CODE.NEXTVAL, 'admin', '관리자', '$2a$10$COvazywgZPXseeKaYhruh.pAYYfcSeGO5aSrHOsLZN0X8joNwW2dW', 'ROLE_ADMIN', 'ohgiraffers@gmail.com');
INSERT INTO TBL_MEMBER VALUES (SEQ_MEMBER_CODE.NEXTVAL, 'test01', '오지라퍼', '$2a$10$N34MRj4tKVD0AxwvEcC8eOLUyBpXloPKE7Yw.S4/kj5fD1OU5BWsi', 'ROLE_USER', 'test01@naver.com');
...
INSERT INTO TBL_REVIEW VALUES (SEQ_REVIEW_CODE.NEXTVAL, 1, 2, '열무김치라떼 리뷰 입니다.', '정말 맛있는 이 라떼 저만 먹을수 없습니다! 꼭 드세요 두번 드세요~!', SYSDATE);
INSERT INTO TBL_REVIEW VALUES (SEQ_REVIEW_CODE.NEXTVAL, 21, 2, '돌미나리백설기 리뷰 입니다.', '돌을 씹어 먹을수 있는 분만 드시기 바랍니다~! 진짜 돌이에요', SYSDATE);
INSERT INTO TBL_REVIEW VALUES (SEQ_REVIEW_CODE.NEXTVAL, 20, 2, '마라깐쇼한라봉 리뷰 입니다.', '한라봉을 먹는데 매콤하네요? 시원합니다~!', SYSDATE);
INSERT INTO TBL_REVIEW VALUES (SEQ_REVIEW_CODE.NEXTVAL, 19, 2, '까나리코코넛쥬스 리뷰 입니다.', '까나리 까나리 신나는 노래~ 나도한번 불러본다', SYSDATE);
INSERT INTO TBL_REVIEW VALUES (SEQ_REVIEW_CODE.NEXTVAL, 18, 2, '붕어빵초밥 리뷰 입니다.', '붕어빵으로 만든 초밥인데 이게 빵인지 붕어인지 모르겠습니다.', SYSDATE);
INSERT INTO TBL_REVIEW VALUES (SEQ_REVIEW_CODE.NEXTVAL, 17, 2, '아이스가리비관자육수 리뷰 입니다.', '이가 시려워 꽁 발이 시려워 꽁 관자육수 때문에 꽁꽁꽁!', SYSDATE);
